...
export function SwarrowLogoMark({ color = 'white', size = 32 }: { color?: string; size?: number }) {
  ...
  return (
    <svg width={width} height={size} viewBox="0 0 41.1219 44" fill="none" aria-hidden="true">
...
export function SwarrowLogotype({ color = 'white', height = 14 }: { color?: string; height?: number }) {
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 200.04 23.904" fill="none" aria-hidden="true">
