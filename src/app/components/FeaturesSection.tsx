...
const features = [
  ...
  },
  {
    ...
    title: '管理機能',
    description:
      'ノーコードで会話フローを作成・編集でき、会話データは外部AI学習に一切使用せず、安全に保護。AIで対応しきれない問い合わせは、自動で担当者に引き継ぎます。',
    image: imgFeature3,
    maskedImage: true,
  },
]
    ...
    <section id="features" className="relative bg-white py-24 lg:py-32 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16 lg:mb-20">
          <p className="text-sc-orange text-[14px] tracking-wider mb-4">FEATURES</p>
            ...
            return (
              ...
              >
                ...
                <div className="relative p-6 lg:p-8 overflow-hidden">
                  ...
                  <span className="absolute top-3 right-5 text-[72px] lg:text-[80px] leading-none text-sc-text-primary opacity-[0.10] select-none pointer-events-none">
                    {feature.number}
                  </span>
                  ...
                  {/* Title */}
                  <h3 className="text-sc-text-primary text-[20px] lg:text-[24px] mb-3">{feature.title}</h3>

                  {/* Description */}
                  <p className="text-sc-text-secondary text-[14px] lg:text-[15px] leading-[1.8]">
                    {feature.description}
                  </p>
                </div>
              </div>
