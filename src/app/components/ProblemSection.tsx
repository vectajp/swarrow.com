import { Clock, Frown, TrendingUp } from 'lucide-react'
...
export function ProblemSection() {
  return (
    <section id="problem" className="relative bg-white py-24 lg:py-32 overflow-hidden">
      <BackgroundArc color="var(--sc-navy)" opacity={0.03} className="w-[700px] h-[700px] -left-[300px] top-[-200px]" />

      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        {/* Section heading */}
        <h2 className="text-sc-text-primary text-[32px] sm:text-[40px] lg:text-[52px] leading-[1.2] text-center mb-16 lg:mb-20">
          問い合わせ対応で
          ...
          {problems.map((problem) => {
            ...
            return (
              ...
              >
                ...
                {/* Title */}
                <h3 className="text-sc-text-primary text-[22px] lg:text-[26px] mb-4">{problem.title}</h3>

                {/* Description */}
                <p className="text-sc-text-secondary text-[15px] lg:text-[16px] leading-[1.8]">{problem.description}</p>
              </div>
            )
          })}
        </div>
