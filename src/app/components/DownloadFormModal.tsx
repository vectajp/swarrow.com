          ...
          {submitted ? (
            ...
            <div className="text-center py-8">
              <div className="w-[64px] h-[64px] bg-sc-orange/10 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--sc-orange)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M20 6L9 17l-5-5" />
                </svg>
              </div>
              <h3 className="text-sc-text-primary text-[24px] font-bold mb-4">
                送信が完了しました
              </h3>
            ...
            /* フォーム */
            <>
              <h3 className="text-sc-text-primary text-[24px] lg:text-[28px] font-bold mb-2">
                資料ダウンロード
              </h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-sc-text-primary text-[14px] font-medium">
                    お問い合わせ内容
                  </label>
                  <textarea
                    name="inquiry"
