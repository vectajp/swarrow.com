...
export const CONVENTIONAL = /^(feat|fix|docs|style|refactor|perf|test|build|ci|chore|revert)(\(.+\))?!?: .+/

/** 許可するブランチ名 (prefix のみ。GH 番号は必須にしない)。 */
export const BRANCH_OK = /^(?:feature|fix|hotfix|chore|docs|refactor)\/.+$|^(?:main|master)$/
